...
export const homeOutdoorProducts = [
  ...
  { name: "cameras", price: 19, image: image2 },
  { name: "Headphones", price: 19, image: image3 },
  { name: "Laptop and Pc", price: 19, image: image4 },
  { name: "Gaming set", price: 100, image: image5 },
  { name: "Electronics catle", price: 39, image: image6 },
  { name: "Home appliance", price: 19, image: image7 },
  { name: "Coffee maker", price: 10, image: image8 },
];

export const customerElectronics=[
  { name: "Soft chairs", price: 19, image: image9 },
  { name: "Sofa & chair", price: 13, image: image10 },
  { name: "Kitchen dishes", price: 19, image: image11 },
  { name: "Smart watches", price: 100, image: image12 },
  { name: "Kitchen mixer", price: 100, image: image13 },
  { name: "Blenders", price: 39, image: image14 },
  { name: "Home appliance", price: 14, image: image15 },
  { name: "Coffee maker", price: 10, image: image16 },
];
